...
class Track:
    ...
    def print_track_pipe(self):
        ...
        print(term.move_xy(pipe_col_goal_left, row_goal - 1) +
              PIPE_GOAL_UL + term.move_right(1) + PIPE_GOAL_UL)
        print(term.move_xy(pipe_col_goal_left, row_goal) +
              PIPE_GOAL_MID_LEFT + term.move_right(1) + PIPE_GOAL_MID_RIGHT)
        print(term.move_xy(pipe_col_goal_left, row_goal + 1) +
              PIPE_GOAL_UL + term.move_right(1) + PIPE_GOAL_UL)
    ...
    def print_track_hyphen(self):
        ...
        if self.shape == "hyphen":
            ...
            print(reverse + term.move_xy(0, row_track) +
